...
from various liquidity pools (LPs),‌ ‌automated market making (AMM) projects,‌ ‌and‌ ‌other yield‌ farming ‌opportunities in the DeFi ecosystem.
                ...
                <div className="item-column">
                  <div className="column-title" style={{marginBottom: '15px'}}> Allocation: <span className="amount_color">10-5,000 BUSD</span><br/> </div>
                  ...
                  <div className="top-div">
                    <div className="amount-container">
                      ...
                      {status ? (
                        ...
                        {/* <div className="approve" onClick={handleDeposit} style={{background:"rgb(122, 119, 110)"}}> */}
                        <div className="approve" style={{background:"rgb(122, 119, 110)"}}>
                          Deposit
                        </div>
                        <div className="claim_box">
                          {/* <div className="claim" onClick={handleInitialClaim} style={{background:"rgb(122, 119, 110)"}}> */}
