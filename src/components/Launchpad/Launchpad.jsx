...
import { privateABI, seedABI } from "../../abi";
import { ethers } from 'ethers'
import { address, privateAddress } from '../../address'
...
const Launchpad = () => {
  ...
  const [privateDeposit, setPrivateDeposit] = useState(0)
        ...
        <div className="ido">
          <div className="tabs-container">
            <div className="tabs">
              ...
              <div className="line-perch"></div>
              <div className={toggleState === 3 ? "tab-pan is-active" : "tab-pan"} onClick={() => toggleTab(3)}>Ended [1]</div>
            </div>
          </div>
          <div className="list">
            {/* Item 1 */}
