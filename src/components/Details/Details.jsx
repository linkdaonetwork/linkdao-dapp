...
from various liquidity pools (LPs),‌ ‌automated market making (AMM) projects,‌ ‌and‌ ‌other yield‌ farming ‌opportunities in the DeFi ecosystem.
                ...
                <div className="item-column">
                  <div className="column-title" style={{marginBottom: '15px'}}> Allocation: <span className="amount_color">200-10,000 BUSD</span><br/> </div>
                  ...
                  <div className="column-value">
                    <span style={{ lineHeight: "1.5px" }}>
                      ...
                      Seed Round - 10% unlocked at TGE. The rest 90% will be unlocked monthly in the next 9 months.
                    </span>
                  </div>
                </div>
                  ...
                  <div className="top-div">
                    <div className="amount-container">
                      ...
                      {/* {status ? ( */}
                        ...
                        {/* <div className="approve"  style={{background:"rgb(122, 119, 110)"}} onClick={handleDeposit}> */}
